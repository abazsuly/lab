...
1. Within the same namespace, using Kube DNS, and with a Service defined,  a pod is resolved to its name
```
curl http://web-service
Welcome to NGINX!
```
2. Within a different namespace, using Kube DNS, and with a Service defined,  a pod is resolved to its name + namespace
```
curl http://web-service.apps
Welcome to NGINX!
```
3. Within a different namespace, using Kube DNS, and with a Service defined,  a pod is resolved to its name + namespace + 'svc'. This creates a less ambiguous and more canonical reference to the domain
```
